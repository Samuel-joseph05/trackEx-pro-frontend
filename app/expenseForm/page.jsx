          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Link
                  href="/expenses"
                  className="flex h-12 w-full items-center justify-center rounded-xl border border-indigo-500 text-lg font-semibold text-indigo-400 transition-all duration-300 hover:bg-indigo-600 hover:text-white hover:shadow-lg hover:shadow-indigo-500/20 active:scale-95"
                >
                  Show Expenses
                </Link>
              </div>
